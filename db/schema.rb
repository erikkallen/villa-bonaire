...
ActiveRecord::Schema.define(:version => 20120714085746) do
  ...
  create_table "refinery_guestbooks", :force => true do |t|
    t.string   "name"
    t.text     "message"
    t.integer  "position"
    t.datetime "created_at", :null => false
  ...
  create_table "refinery_reservations", :force => true do |t|
    t.string   "name"
    t.string   "sirname"
    t.string   "address"
    t.string   "city"
